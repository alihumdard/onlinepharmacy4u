                                                    ...
                                                    <div class="col-4 text-center d-flex justify-content-center">
                                                        <div style="width: 100%;">
                                                            <input type="number" placeholder="0 ٪" max="100"
                                                                min="0.01" step="0.01" style="text-align: center;"
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="col-12 px-4 border-1 mt-3 mb-4">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <input type="text" name="firstName"
                                                            value="{{ $order['firstName'] ?? old('firstName') }}"
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <input type="text" name="lastName"
                                                            value="{{ $order['lastName'] ?? old('lastName') }}"
                                                ...
                                                <h5 class="fw-bold large mt-3"
                                                    style="text-decoration: underline !important;">Address Information:
                                                </h5>
                                                <div class="row">
                                                    <div class="col-md-6 mt-2">
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <input type="address2" name="address2"
                                                            value="{{ $order['address2'] ?? old('address2') }}"
                                                    ...
                                                    <div class=" col-md-6 mt-2">
                                                        ...
                                                        <input type="zip_code" name="zip_code"
                                                            value="{{ $order['zip_code'] ?? old('zip_code') }}"
                                                ...
                                                <h5 class="fw-bold large mt-3"
                                                    style="text-decoration: underline !important;">Shipping Method:</h5>
                                                <div class="row">
                                                    <div class="col-md-12 mt-2 d-flex justify-content-center gap-5">
                                                        <div class="form-check">
                                                            <div class="custom-control">
                                                                <input class="form-check-input" type="radio"
                                                                    name="shiping_cost" id="fast_delivery" value="3.95"
                                                                    data-ship="3.95" checked="" required="">
                                                        ...
                                                        <div class="form-check">
                                                            <div class="custom-control">
                                                                <input class="form-check-input" type="radio"
                                                                    name="shiping_cost" id="express_delivery"
                                                                    value="4.95" data-ship="4.95" required="">
                                                                <label class="form-check-label"
                                                                    for="express_delivery">Royal Mail Tracked 24
