    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1><a href="javascript:void(0);" onclick="window.history.back();" class="btn btn-primary-outline fw-bold "><i
                        class="bi bi-arrow-left"></i> Back</a> | Medical Professionals Orders</h1>
            <nav>
                <ol class="breadcrumb">
                                        ...
                                        <tr>
                                            <td style="align-items: center; ">
                                                <div class="text-center d-flex align-items-center justify-content-center">
                                                    <input class="custom-checkbox" id="checkbox_{{ $val['id'] }}"
                                                        name="checkbox_{{ $val['id'] }}" type="checkbox"
                                                        value="{{ $val['id'] }}">
                                                </div>
                                            </td>
                                            <td>{{ ++$key }}</td>
                                            <td>
                                                <a href="{{ route('admin.orderDetail', ['id' => base64_encode($val['id'])]) }}"
                                                    class="text-primary mb-0 font-weight-semibold fw-bold"
                                            ...
                                            <td>
                                                @if (isset($order_history[$val['email']]))
                                                    <span
                                                        class=" px-5 fw-bold">{{ $order_history[$val['email']]['total_orders'] ?? 0 }}
                                                    </span>
                                                @endif
                                            </td>
                                            @php
                                            ...
                                            <td>{{ $val['shipingdetails']['firstName'] . ' ' . $val['shipingdetails']['lastName'] ?? $val['user']['name'] }}
                                            </td>
                                            @if ($user->role == user_roles('1'))
                                            ...
                                            <td><span
                                                    class="btn  fw-bold {{ $val['status'] == 'Not_Approved' ? 'btn-danger' : '' }} {{ $val['status'] == 'Approved' ? 'btn-success' : '' }} {{ $val['status'] == 'Received' ? 'btn-primary' : '' }} {{ $val['status'] == 'Not_Approved' ? 'btn-danger' : '' }}">{{ $val['status'] ?? '' }}</span>
                                            </td>
                                            <td style="display: inline-block;">
                                                @if ($val['status'] != 'Received')
                                                    <span>{{ $val['approved_by']['name'] }}
                                                        ({{ $val['approved_by']['email'] }} )</span>
                                                @endif
                                            </td>
                                            @if ($user->role != user_roles('3'))
                                                <td style="display: inline-block;">
                                                    @if ($val['status'] == 'Approved')
                                                        <span data-order_id="{{ $val['id'] }}"
                                                            class="btn  ship_now fw-bold btn-primary no-wrap">Ship
                                                            Now</span>
                                                    @endif
