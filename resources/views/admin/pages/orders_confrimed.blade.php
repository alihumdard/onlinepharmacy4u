...
@section('title', 'Orders Confirmed')
@section('content')
<!-- main stated -->
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1><a href="javascript:void(0);" onclick="window.history.back();" class="btn btn-primary-outline fw-bold "><i class="bi bi-arrow-left"></i> Back</a> | Orders Confirmed</h1>
        <nav>
            <ol class="breadcrumb">
