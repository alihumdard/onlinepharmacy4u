    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1><a href="javascript:void(0);" onclick="window.history.back();" class="btn btn-primary-outline fw-bold "><i
                        class="bi bi-arrow-left"></i> Back</a> | Products</h1>
            <nav>
                <ol class="breadcrumb">
                    ...
                    <div class="card">
                        ...
                        <div class="row mb-3 px-4">
                            ...
                            <div class="col-md-4  mt-2 d-block">
                                ...
                                <select id="sub_category" class="form-select select2"
                                    data-placeholder="search sub category...">
                                    <option value="All">All</option>
                            ...
                            <div class="col-md-4  mt-2 d-block">
                                ...
                                <select id="child_category" class="form-select select2"
                                    data-placeholder="search child category...">
                                    <option value="All">All</option>
                            ...
                            <div class="col-md-4  mt-2 d-block">
                                ...
                                <select id="template" class="form-select select2" data-placeholder="search template...">
                                    ...
                                    @foreach ($filters['templates'] ?? [] as $key => $template)
                                        <option value="{{ config('constants.PRODUCT_TEMPLATES')[$template] }}">
                                            {{ config('constants.PRODUCT_TEMPLATES')[$template] }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3 text-center mt-2 d-block">
                                <label for="endDate" class="form-label fw-bold">Trash</label>
                                <a href="{{ route('admin.proTrash') }}"
                                    class="form-control btn btn-success py-2 fw-bold">Go to Trash</a>
                            </div>
                            ...
                            <table id="tbl_data" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($products as $value)
                                        <tr>
                                            {{-- <th style="vertical-align: middle; text-align: center;">{{ $loop->iteration }}</th> --}}
                                            <th style="vertical-align: middle; text-align: center;">{{ $loop->index + $products->firstItem() }}</th>
                                            ...
                                            <td style="vertical-align: middle; text-align: center;">
                                                <div style="display:flex; justify-content: space-around;">
                                                    <div>
                                                        <a class="edit" style="cursor: pointer;" title="Edit" data-id="{{ $value['id'] }}" data-toggle="tooltip"><i class="bi bi-pencil-square"></i></a>
                                                        <a target="_blank" href="{{ route('web.product', ['id' => $value['slug']]) }}" class="preview" style="cursor: pointer; font-size:larger;" title="Preview" data-id="{{ $value['id'] }}" data-toggle="tooltip"><i class="bi bi-eye"></i></a>
                                                    </div>
                                                    <div>
                                                        <a class="duplicate" style="cursor: pointer;" title="Duplicate Product" data-id="{{ $value['id'] }}" data-toggle="tooltip"><i class="bi bi-copy"></i></a>
                                                        <a class="delete" style="cursor: pointer;" title="Delete" data-status="{{ config('constants.STATUS')['Deactive'] }}" data-id="{{ $value['id'] }}" data-toggle="tooltip"><i class="bi bi-trash-fill"></i></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
