...
@section('title', 'Add Prescription Med Question')
@section('content')
<style>
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1<a href="javascript:void(0);" onclick="window.history.back();" class="btn btn-primary-outline fw-bold "><i class="bi bi-arrow-left"></i> Back</a> | Add Prescription Med Question</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/">Home</a></li>
                <li class="breadcrumb-item">Pages</li>
                <li class="breadcrumb-item active">Add Prescription Question</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
