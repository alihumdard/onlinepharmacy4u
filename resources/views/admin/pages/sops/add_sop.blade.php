                        ...
                        <form class="row g-3 mt-3 needs-validation" method="post" action="{{ route('admin.storeSOP') }}" novalidate enctype="multipart/form-data">
                            ...
                            <div class="col-6 mt-2 file">
                                ...
                                <div class="d-flex align-items-center" style="gap: 20px; justify-content: space-between;">
                                    <input type="file" class="form-control w-100" id="file" name="file" value="{{ ($sop['file'] ?? NULL) ? 'required' : '' }}" {{ (isset($sop) && $sop['file']) ? '' : 'required' }} onchange="previewMainfile(this)">
                                    <label for="file" class=" d-block ">
                                        <img id="file_preview" src="{{  $path ?? '' }}" class="rounded-circle" alt="no file" style="width: 45px; height: 45px;  cursor:pointer;   object-fit: cover;">
                                    </label>
                            ...
                            <div class="col-md-6 parent-div">
                                ...
                                <select id="file_for" name="file_for" class="form-select" required>
                                    <option value="both">Both Despensery & Medical Professional</option>
                                    <option value="dispensary">Only For Dispensary</option>
                                    <option value="doctor">Only For Medical Professional</option>
                                </select>
