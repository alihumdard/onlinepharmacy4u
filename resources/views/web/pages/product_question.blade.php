...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-8">
            @foreach ($question_category as $key => $val)
                <div class="{{ $key == 0 ? 'firstconsultationstart' : 'secondConsultationStart'}}">
                    <div class="text">
                        <h2>{{ $val->name }}</h2>
                    ...
                    <form action="#">
                        @php
                            $count = 0; 
                        @endphp
                        @foreach ($questions[$val->id] as $question)
                            <div class="form-group q{{++$count}}">
                                <div class="d-flex align-items-center ">
                                    <p class="me-auto">{{$question->question_title}}</p>
