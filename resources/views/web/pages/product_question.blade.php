            ...
            <div class="firstconsultationstart">
                ...
                <form action="#">
                    ...
                    <div class="form-group" id="q3">
                        ...
                        @if($question['class'] != 'd-none')
                        <div class="d-flex align-items-center {{$question['class']}} ">
                            <p class="me-auto"> Q{{ $question['id']}}
                            {{$question['title']}} </p>
                            <button type="button" class="btn btn-lg " >Yes</button>
                            <button type="button" class="btn btn-lg noButton click_yes" data-next={{$next_quest_opt[$question['id']]['yes_lable'] ?? ''}}>No</button>
                        </div>
                        @else
                        <div class="{{$question['class']}}" id="quest_{{$question['id']}}">
                    ...
                    <script>
                        $('.click_yes').on('click', function() {
                            let id_next = $(this).attr('data-next');
                            $('#quest_' + id_next).toggleClass('d-none');
                        });
                    </script>
                    <p> the above code is test</p>
