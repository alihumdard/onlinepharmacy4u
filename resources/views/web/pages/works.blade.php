            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="about-us-img-wrap about-img-left">
                        <img src="img/Pharmacy4banners/service(800x1031px)(2).webp" alt="About Us Image">
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
...
<div class="ltn__about-us-area bg-overlay-white-90--- bg-image pt-10 pb-10" >
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 align-self-center">
                <div class="about-us-info-wrap">
                    <div class="section-title-area ltn__section-title-2--- mb-20">
                        ...
                        <h1 class="section-title">Select Your Treatment</h1>
                        <p>All of our experienced UK Independent prescribers are registered with the General Pharmaceutical Council (GPhC) & Nursing and Midwifery Council  (NMC) they will review your consultation immediately. Once approved Online Pharmacy 4U medical team will then recommend a treatment and issue a FREE* prescription.</p>
                    </div>
                    <ul class="ltn__list-item-1 ltn__list-item-1-before--- clearfix">
            ...
            <div class="col-lg-6 align-self-center">
                <div class="about-us-img-wrap about-img-left">
                    <img src="img/Pharmacy4banners/homepage(740x882px)(3).webp" alt="About Us Image">
                </div>
            </div>
        </div>
    </div>
...
<div class="ltn__about-us-area bg-overlay-white-90--- bg-image pt-60 pb-110" >
    <div class="container">
        <div class="row">
            <div class="col-lg-6 align-self-center">
                <div class="about-us-img-wrap about-img-left">
                    <img src="img/Pharmacy4banners/Homepage2nd(1140x1210px)(2).webp" alt="About Us Image">
                </div>
            </div>
            <div class="col-lg-6 align-self-center">
                <div class="about-us-info-wrap">
